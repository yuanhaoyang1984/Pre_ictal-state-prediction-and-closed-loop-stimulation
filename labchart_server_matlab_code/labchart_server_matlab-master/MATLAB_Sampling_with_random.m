...
global st
global random_elec_mode   % =1 means random mode
global random_stim_n      % how many times for stimulus in 30min n
global random_last_time   % last cycle
global random_stim_count  % stimulus already happened
...
pause_signal = 0;
random_elec_mode = 0;   % 1 = random mode on 
random_stim_n = 10;     % random number of stimulus in 30mins
random_last_time = clock;
random_stim_count = 0;
